...
print('oh why hello '+name+' its nice to meet darling!') # chatting with the user , we inserted the variable that the user set
...
""""
And thats it! this is simple code that you can review and analze and study
